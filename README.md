...
**Data Scientist / ML / NLP Engineer (Junior)**
...
| **Deep Learning** | PyTorch, MLP, CNN, transfer learning |
| **NLP / LLM** | Transformers, PEFT (QLoRA), SFTTrainer, llama-cpp-python, tool-calling, STT (Vosk), TTS (pyttsx3) |
