...
Проектирую AI-ассистентов и автоматизации: дообучение моделей под tool-calling, подключение баз знаний, интеграции с внешними системами через REST и вебхуки. Построил конвейер автоматизированной разработки: агент-оркестратор управляет несколькими экземплярами Codex, проводит автоматическое ревью и замыкает loop-prompting. Автор 95 собственных скиллов агента — UI/UX, тесты, ревью, оркестрация.
...
| **Агенты и интеграции** | Мультиагентная оркестрация, loop-prompting, FastAPI, REST API, вебхуки, cron |
| **Практики** | pytest, Git, CI (GitHub Actions), Docker, Linux |
...
- [**Конвейер автоматизированной разработки**](https://github.com/P0n9L1) — Hermes Agent как оркестратор нескольких экземпляров Codex: постановка задач, автоматическое ревью (соответствие ТЗ → качество кода), loop-prompting до прохождения проверок. Авторские скиллы: 95 шт., 1087 применений
